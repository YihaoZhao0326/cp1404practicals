...
above_9_numbers = [number for number in numbers if number > 9]
print(above_9_numbers)
...
last_name_of_the_longer_name = [name.split()[1] for name in full_names if len(name) > 11]
print(', '.join(last_name_of_the_longer_name))
